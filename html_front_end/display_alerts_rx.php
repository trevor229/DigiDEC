...
$conn=mysqli_connect($db_params['host'], $db_params['user'], $db_params['password'], $db_params['rxdbname'], $db_params['port'], $db_params['socket']);
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<td><P class=\"tabletext\" id=\"description\">" . $row['FILTER'] . "</td>";
        echo "<td><P class=\"tabletext\" id=\"description\">" . $row['MON'] . "</td>";
